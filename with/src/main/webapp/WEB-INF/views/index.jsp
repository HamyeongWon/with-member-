                        ...
                        <div class="col mb-5">
                            <div class="card h-100">
                                <div class="product-img">
                                    <a href="${pageContext.request.contextPath}/product/view?p_num=${item.p_num}">
                                        <img class="card-img-top" src="${pageContext.request.contextPath}${item.path1}" alt="${item.p_name}" />
                                    </a>
                                </div>
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center">
                                        <a
                                            ...
                                            href="${pageContext.request.contextPath}/product/view?product_num=${item.p_num}"
                                            >상품페이지로 이동</a
                                        >
                                    </div>
                                </div>
