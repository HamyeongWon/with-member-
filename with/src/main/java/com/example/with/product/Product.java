...
public class Product {
	...
	public Product(int product_num, String product_title, int product_price, String product_content, int category1_num,
			int category2_num, int category3_num, String product_writer, Date product_add_date, String stringDate,
			int product_hit, int product_type, MultipartFile file1, MultipartFile file2, MultipartFile file3,
			String path1, String path2, String path3, Member member, Category c1, Category c2, Category c3) {
		super();
	...
	public String toString() {
		return "Product [product_num=" + product_num + ", product_title=" + product_title + ", product_price="
				+ product_price + ", product_content=" + product_content + ", category1_num=" + category1_num
				+ ", category2_num=" + category2_num + ", category3_num=" + category3_num + ", product_writer="
				+ product_writer + ", product_add_date=" + product_add_date + ", stringDate=" + stringDate
				+ ", product_hit=" + product_hit + ", product_type=" + product_type + ", file1=" + file1 + ", file2="
				+ file2 + ", file3=" + file3 + ", path1=" + path1 + ", path2=" + path2 + ", path3=" + path3
				+ ", member=" + member + "]";
	}
